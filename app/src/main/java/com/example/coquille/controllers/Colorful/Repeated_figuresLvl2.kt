...
class Repeated_figuresLvl2 : AppCompatActivity() {
    ...
    fun genSequence( ) {
        ...
        * dentro de la misma buscamos la lista con valores correspodientes*/
        ...
        val listToSort = mutableListOf(imageResource, imageResource2, imageResource2, imageResource3, imageResource3, imageResource4, imageResource4, imageResource5, imageResource5)
